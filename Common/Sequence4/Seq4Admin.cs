...
namespace LOR4
{
	public static class LOR4Admin
	{
		...
		public const string FILE_CHLIST = "Channel List *.ChList|*.ChList";
		public const string FILE_CHMAP = "Util-O-Rama Channel Map *.ChMap|*.ChMap";
		...
		public const string CSVHEAD_CHLIST = "Type, Name, SavedIndex";
