...
namespace LOR4Utils
{
	public static class lutils
	{
		...
		*/
		...
		#region TreeStuff
		public static void TreeFillChannels(TreeView tree, LOR4Sequence seq, ref List<TreeNode>[] nodesBySI, bool selectedOnly, bool includeRGBchildren)
		{
		...
		public static void TreeFillChannels(TreeView tree, LOR4Sequence seq, ref List<TreeNode>[] nodesBySI, bool selectedOnly, bool includeRGBchildren, int memberTypes)
		{
		...
		private static TreeNode TreeAddTrack(LOR4Sequence seq, TreeNodeCollection baseNodes, LORTrack4 track, ref List<TreeNode>[] nodesBySI, bool selectedOnly,
			bool includeRGBchildren, int memberTypes)
		{
			...
			//if ((memberTypes & LOR4SeqEnums.MEMBER_Track) > 0)
			//{
		...
		private static TreeNode TreeAddGroup(LOR4Sequence seq, TreeNodeCollection baseNodes, LOR4ChannelGroup group, ref List<TreeNode>[] nodesBySI, bool selectedOnly,
			bool includeRGBchildren, int memberTypes)
		{
		...
		private static TreeNode TreeAddCosmic(LOR4Sequence seq, TreeNodeCollection baseNodes, LOR4Cosmic device, ref List<TreeNode>[] nodesBySI, bool selectedOnly,
			bool includeRGBchildren, int memberTypes)
		{
		...
		private static TreeNode TreeAddChannel(LOR4Sequence seq, TreeNodeCollection baseNodes, LOR4Channel channel, bool selectedOnly)
		{
			...
			//channelNode.ImageIndex = imlTreeIcons.Images.IndexOfKey("LOR4Channel");
			//channelNode.SelectedImageIndex = imlTreeIcons.Images.IndexOfKey("LOR4Channel");
		...
		private static TreeNode TreeAddRGBchannel(LOR4Sequence seq, TreeNodeCollection baseNodes, LOR4RGBChannel rgbChannel, ref List<TreeNode>[] nodesBySI, bool selectedOnly, bool includeRGBchildren)
		{
			...
			{
				iLOR4Member mbrR = seq.Members.bySavedIndex[RGBsi];
