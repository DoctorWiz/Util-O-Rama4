...
namespace LOR4Utils
{
	...
	public class TreeUtils
	{
		...
		#region TreeStuff
		public static void TreeFillChannels(TreeViewAdv tree, LOR4Sequence seq, ref List<TreeNodeAdv>[] nodesBySI, bool selectedOnly, bool includeRGBchildren)
		{
		...
		public static void TreeFillChannels(TreeViewAdv tree, LOR4Sequence seq, ref List<TreeNodeAdv>[] nodesBySI, bool selectedOnly, bool includeRGBchildren, int memberTypes)
		{
		...
		private static TreeNodeAdv TreeAddTrack(LOR4Sequence seq, TreeNodeAdvCollection baseNodes, LORTrack4 track, ref List<TreeNodeAdv>[] nodesBySI, bool selectedOnly,
		...
		private static TreeNodeAdv TreeAddGroup(LOR4Sequence seq, TreeNodeAdvCollection baseNodes, LOR4ChannelGroup group, ref List<TreeNodeAdv>[] nodesBySI, bool selectedOnly,
			bool includeRGBchildren, int memberTypes)
		{
		...
		private static TreeNodeAdv TreeAddCosmic(LOR4Sequence seq, TreeNodeAdvCollection baseNodes, LOR4Cosmic device, ref List<TreeNodeAdv>[] nodesBySI, bool selectedOnly,
			bool includeRGBchildren, int memberTypes)
		{
		...
		private static TreeNodeAdv TreeAddRGBchannel(LOR4Sequence seq, TreeNodeAdvCollection baseNodes, LOR4RGBChannel rgbChannel, ref List<TreeNodeAdv>[] nodesBySI, bool selectedOnly, bool includeRGBchildren)
		{
