...
{
    public partial class FuzzyFunctions // SmithWatermanGotohWindowedAffine : AbstractStringMetric
    {
        private const double EstimatedTimingConstant = 4.5000000682193786E-05;
        private const int DefaultWindowSize = 100;

        public static double SmithWatermanSimilarity(this string firstWord, string secondWord)
        {
            if (firstWord == null || secondWord == null)
            {
                return DefaultMismatchScore;
            }
            double unnormalisedSimilarity = firstWord.UnnormalisedSmithWatermanSimilarity(secondWord);
