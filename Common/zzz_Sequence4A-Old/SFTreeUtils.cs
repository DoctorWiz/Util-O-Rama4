...
namespace LORUtils4
{
	...
	public class TreeUtils
	{
		...
		private static TreeNodeAdv TreeAddCosmic(LORSequence4 seq, TreeNodeAdvCollection baseNodes, LORCosmic device, ref List<TreeNodeAdv>[] nodesBySI, bool selectedOnly,
			bool includeRGBchildren, int memberTypes)
		{
