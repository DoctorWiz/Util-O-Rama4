...
namespace UtilORama4
{
	public static class vamps
	{
		...
		*/
		...
		public static readonly string FILEqmPoly = "qm-transcription.n3";
		...
		*/
		...
		public static readonly string GRIDBEATS = "Beats";
		public static readonly string GRIDONSETS = "Note Onsets";
		//private const string MASTERTRACK = "Song Information [Tune-O-Rama]";
		public const string MASTERTRACK = "Beats + Song Information [Vamp-O-Rama]";
		public const string MASTERMATCH = "Beats + Song ";
		public const string GROUPBEATS = "Bars and Beats";
		public const string GROUPPOLY = "Polyphonic Transcription";
		public const string GROUPCONSTQ = "Constant Q Spectrogram";
		public const string GROUPSEGMENTS = "Segments";
		public const string GROUPSPECTRO = "Spectrogram";
		public const string GROUPCHROMA = "Chromagram";
		public const string GROUPKEY = "Pitch and Key";
		//public const string GROUPPITCH = "Pitch";
		public const string GROUPTONAL = "Tonal Change";
		//public const string GROUPVOCALS = "Vocals and Speech";
		public const string GROUPONSETS = "Note Onsets";
		public const string GROUPMELODY = "Melody";
		public const string GROUPSPEECH = "Speech";
		public const string CHANbeats = "Beats";
