...
namespace FuzzORama
{
	...
	public static partial class FuzzyFunctions
	{
		...
		//    no gaps
		private const long USE_JAROWINKLER = 0x000080; //     128
		private const long USE_DAMERAULEVENSHTEIN = 0x000400; //    1024
		private const long USE_YETILEVENSHTEIN = 0x000800; //    2048
		private const long USE_LONGESTCOMMONSUBSTRING = 0x004000; //   16384
		private const long USE_SIFT = 0X200000; // 2097152
		private const long USE_SORENSENDICE = 0x400000; // 4194304
