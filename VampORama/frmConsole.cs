  ...
  public partial class frmConsole : Form
	{
		...
		{
			InitializeComponent();
			listBoxLog = new ListBoxLog(logConsole);
    ...
    public void Log(Level lev, string theMsg)
		{
      listBoxLog.Log(lev, theMsg);
		}
    ...
    public sealed class ListBoxLog : IDisposable
    {
      ...
      this.Close();
		...
		{
      logConsole.Width = this.ClientSize.Width;
      logConsole.Height = this.ClientSize.Height - btnClose.Height - 10;
      btnClose.Top = this.ClientSize.Height - btnClose.Height - 5;
