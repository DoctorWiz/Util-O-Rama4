...
{ 
	public static partial class FuzzyFunctions
	{
		...
		public static unsafe int YetiLevenshteinDistance(string source, string target, int substitionCost)
		{
			...
			fixed (char* p2 = target)
			{
				return YetiLevenshteinDistance(p1, source.Length, p2, target.Length, xc);
			}
		}
		/// <summary>
