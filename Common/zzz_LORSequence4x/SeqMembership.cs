...
namespace LORUtils4
{
		public class LORMembership4 : IEnumerator, IEnumerable  //  IEnumerator<iLORMember4>
	{
		...
		public LORMembership4(iLORMember4 myOwner)
		{
			if (myOwner == null)
			{
		...
		public int Add(iLORMember4 newMember)
		{
			...
			if (owner.MemberType == LORMemberType4.Sequence)
			{
				...
				if (need2add)
				{
					...
					if (newMember.MemberType == LORMemberType4.Cosmic)
					{
						parentSequence.CosmicDevices.Add((LORCosmic4)newMember);
					}
					if (newMember.MemberType == LORMemberType4.Track)
					{
		...
		public LORSequence4 Parent
		{
			get
			{
				LORSequence4 myParent = null;
				if (owner != null)
				{
		...
		public void SetParent(LORSequence4 theParent)
		{
			if (theParent == null)
			{
				System.Diagnostics.Debugger.Break();
