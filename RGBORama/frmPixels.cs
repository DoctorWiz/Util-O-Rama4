...
namespace RGBORama
{
    public partial class frmKeywdels : Form
    {
        ...
        private void frmKeywdels_Load(object sender, EventArgs e)
        {

        }

        public void setKeywdel(int x, int y, int r, int g, int b)
        {
        ...
        private void frmKeywdels_Paint(object sender, PaintEventArgs e)
        {
