        ...
        private void lorilizeButton_Click(object sender, EventArgs e)
        {
            ...
            if (chGet > 0)
            {
                ...
                if (bState == 0)
                {
                    ...
                    if (pState == 0)
                    {
                        iRet = MessageBox.Show("File " + fileTextBox.Text + " successfully loraxed for " + chGet.ToString() + "channels.  " + changesMade.ToString() + " changes made.", "Lorilize Completed Sucessfully", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                }
                else
                {
