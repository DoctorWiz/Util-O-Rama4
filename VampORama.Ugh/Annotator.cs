...
namespace UtilORama4
{
	public static class Annotator
	{
		...
		public static xTimings xKeys = new xTimings(VampBarBeats.keysName);
		...
		public static xTimings xSegments = new xTimings(VampSegments.transformName);
		...
		public static LOR4Channel[] noteChannels = null;
		...
		public static string TempPath = Fyle.GetMyTempPath("Vamps");
		...
		public static void Init(LOR4Sequence sequence)
		{
			Clear();
			Sequence = sequence;
			VampTrack = Sequence.FindTrack(vamps.MASTERTRACK, true);
		}
