namespace UtilORama4
{
	partial class frmMapper
	{
      ...
      this.cboDestFile = new System.Windows.Forms.ComboBox();
      this.cboMappingFile = new System.Windows.Forms.ComboBox();
      ...
      // pnlAll
      // 
      this.pnlAll.Controls.Add(this.cboDestFile);
      this.pnlAll.Controls.Add(this.cboSourceFile);
      ...
      this.cboSourceFile.Location = new System.Drawing.Point(19, 47);
      this.cboSourceFile.Name = "cboSourceFile";
      this.cboSourceFile.Size = new System.Drawing.Size(349, 23);
      this.cboSourceFile.TabIndex = 132;
      // 
      // cboDestFile
      // 
      this.cboDestFile.FormattingEnabled = true;
      this.cboDestFile.Location = new System.Drawing.Point(483, 46);
      this.cboDestFile.Name = "cboDestFile";
      this.cboDestFile.Size = new System.Drawing.Size(349, 23);
      this.cboDestFile.TabIndex = 133;
      // 
      // cboMappingFile
      // 
      this.cboMappingFile.FormattingEnabled = true;
      this.cboMappingFile.Location = new System.Drawing.Point(234, 740);
      this.cboMappingFile.Name = "cboMappingFile";
      this.cboMappingFile.Size = new System.Drawing.Size(349, 23);
      this.cboMappingFile.TabIndex = 133;
      // 
      // frmMapper
      // 
      this.AllowDrop = true;
      ...
      this.Controls.Add(this.cboMappingFile);
    ...
    private ComboBox cboDestFile;
    private ComboBox cboSourceFile;
    private ComboBox cboMappingFile;
  }
}
