...
namespace RGBORama
{
	class pixel
	{
		...
		public LOR4EffectType redEffectType = LOR4EffectType.Intensity;
		public LOR4EffectType grnEffectType = LOR4EffectType.Intensity;
		public LOR4EffectType bluEffectType = LOR4EffectType.Intensity;
